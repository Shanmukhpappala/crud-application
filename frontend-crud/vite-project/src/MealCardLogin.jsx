...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 sm:p-10 mx-2">
        <h2 className="text-2xl font-bold text-center mb-8 text-gray-800">Login to Meal Card</h2>
